...
int main(int argc, char **argv)
{
    ...
    srv_takeoff.request.latitude = contract.job.location.start_lat;
    srv_takeoff.request.longitude = contract.job.location.start_long;
    ...
    srv_land.request.latitude = asset.power(nearest);
    srv_land.request.longitude = asset.power(nearest);
